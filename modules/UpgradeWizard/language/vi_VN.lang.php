...
$mod_strings = array(
    ...
    'LBL_UW_START_DESC2' => 'Lưu ý: Chúng tôi đặc biệt khuyên bạn nên tạo một bản sao của phiên bản SuiteCRM bạn sử dụng trong sản xuất và kiểm tra gói nâng cấp trước khi triển khai phiên bản mới. Nếu bạn đã thay đổi tệp "composer.json", thì vui lòng, sau khi quá trình nâng cấp hoàn tất, hãy chạy lệnh này: <br/><br/><pre>composer install --no-dev</pre>', // Keep the <pre>composer install --no-dev</pre> words at the end of the sentence and do not translate it
