...
$mod_strings = array(
    ...
    'ERR_DELETE_RECORD' => 'Số hồ sơ phải được xác định để xóa bỏ KH Tiềm năng.',
    ...
    'LBL_CONTACT_NAME' => 'Tên KH Tiềm năng:',
    'LBL_CONTACT_OPP_FORM_TITLE' => 'KH Tiềm năng-Cơ hội:',
    'LBL_CONTACT_ROLE' => 'Vai trò:',
    'LBL_CONTACT' => 'KH Tiềm năng:',
    ...
    'LBL_CONVERTLEAD_WARNING' => 'Cảnh báo: Trạng thái của KH Tiềm năng bạn chuyển đổi thành "Đã chuyển đổi". Bản ghi Liên hệ và/hoặc Tài khoản có thể đã được tạo từ KH Tiềm năng. Nếu bạn muốn tiếp tục chuyển đổi KH Tiềm năng, hãy nhấp vào Save. Để quay lại KH Tiềm năng mà không chuyển đổi nó, hãy nhấp vào Hủy.',
    ...
    'LBL_VCARD' => 'vCard',
    'LBL_IMPORT_VCARDTEXT' => 'Tự động tạo một KH Tiềm năng mới bằng cách nhập khẩu vCard tập tin hệ thống của bạn.',
    'LBL_INVALID_EMAIL' => 'Email không tồn tại:',
    'LBL_INVITEE' => 'Báo cáo trực tiếp',
    'LBL_LAST_NAME' => 'Họ:',
    'LBL_LEAD_SOURCE_DESCRIPTION' => 'Mô tả nguồn KH Tiềm năng:',
    'LBL_LEAD_SOURCE' => 'Nguồn KH Tiềm năng:',
    'LBL_LIST_ACCEPT_STATUS' => 'Tình trạng chấp nhận',
    'LBL_LIST_ACCOUNT_NAME' => 'Tên tài khoản',
    'LBL_LIST_CONTACT_NAME' => 'Tên KH Tiềm năng',
    'LBL_LIST_CONTACT_ROLE' => 'Vai trò',
    'LBL_LIST_DATE_ENTERED' => 'Ngày tạo',
    'LBL_LIST_EMAIL_ADDRESS' => 'Hộp thư đến',
    'LBL_LIST_FIRST_NAME' => 'Tên',
    'LBL_LIST_FORM_TITLE' => 'Danh sách KH Tiềm năng',
    'LBL_LIST_LAST_NAME' => 'Họ',
    'LBL_LIST_LEAD_SOURCE_DESCRIPTION' => 'Mô tả nguồn KH Tiềm năng',
    'LBL_LIST_LEAD_SOURCE' => 'Nguồn KH Tiềm năng',
    'LBL_LIST_MY_LEADS' => 'KH Tiềm năng',
    'LBL_LIST_NAME' => 'Tên',
    ...
    'LBL_MODULE_TITLE' => 'KH Tiềm năng: Tr.chính',
    'LBL_NAME' => 'Tên:',
    'LBL_NEW_FORM_TITLE' => 'KH Tiềm năng mới',
    ...
    'LBL_SEARCH_FORM_TITLE' => 'Tìm kiếm KH Tiềm năng',
    'LBL_SELECT_CHECKED_BUTTON_LABEL' => 'Chọn lựa KH Tiềm năng',
    'LBL_SELECT_CHECKED_BUTTON_TITLE' => 'Chọn lựa KH Tiềm năng',
    'LBL_STATE' => 'Tiểu bang hoặc khu vực:',
    'LBL_STATUS_DESCRIPTION' => 'Mô tả trạng thái:',
    'LBL_STATUS' => 'Trạng thái:',
    'LBL_TITLE' => 'Chức vụ:',
    'LNK_IMPORT_VCARD' => 'Tạo KH Tiềm năng từ vCard',
    ...
    'NTC_REMOVE_CONFIRMATION' => 'Bạn có muốn loại bỏ KH Tiềm năng từ Vụ việc này?',
    ...
    'LNK_IMPORT_LEADS' => 'Nhập KH Tiềm năng',
//Convert lead tooltips
    'LBL_MODULE_TIP' => 'Các Module để tạo ra một bản ghi mới trong.',
    'LBL_REQUIRED_TIP' => 'Các module cần thiết phải được tạo ra hoặc được chọn trước khi KH Tiềm năng có thể được chuyển đổi.',
    'LBL_COPY_TIP' => 'Nếu đã kiểm tra, các trường từ KH Tiềm năng sẽ được sao chép vào các trường có cùng tên trong các bản ghi vừa tạo.',
    ...
    'LBL_ACTIVITIES_MOVE_HELP' => "Chọn bản ghi để di chuyển các hoạt động của KH Tiềm năng. Nhiệm vụ, Cuộc gọi, Cuộc họp, Ghi chú và Email sẽ được di chuyển đến các bản ghi đã chọn.",
    'LBL_ACTIVITIES_COPY_HELP' => "Chọn (các) hồ sơ để tạo bản sao các hoạt động của KH Tiềm năng. Tác vụ mới, Cuộc gọi, Cuộc họp và Ghi chú sẽ được tạo cho mỗi bản ghi đã chọn. Email sẽ liên quan đến (những) bản ghi đã chọn.",
    //For export labels
