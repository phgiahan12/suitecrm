...
$mod_strings = array(
    ...
    'LBL_MODULE_TITLE' => 'KH Mục tiêu: Tr.chính',
    ...
    'LBL_NAME' => 'Tên:',
    'LBL_PROSPECT_INFORMATION' => 'Xem toàn bộ KH Mục tiêu', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_DUPLICATE' => 'Có khả năng trùng KH Mục tiêu',
    'MSG_SHOW_DUPLICATES' => 'Bản ghi KH Mục tiêu bạn sắp tạo có thể là bản sao của một bản ghi KH Mục tiêu đã tồn tại. Các bản ghi KH Mục tiêu có chứa tên và / hoặc địa chỉ email tương tự được liệt kê dưới đây. <br> Nhấp vào Tạo KH Mục tiêu để tiếp tục tạo KH Mục tiêu mới này hoặc chọn một KH Mục tiêu hiện có được liệt kê dưới đây.',
    'MSG_DUPLICATE' => 'Bản ghi KH Mục tiêu bạn sắp tạo có thể là bản sao của một bản ghi KH Mục tiêu đã tồn tại. Các bản ghi KH Mục tiêu có chứa tên và / hoặc địa chỉ email tương tự được liệt kê dưới đây. <br> Nhấp vào Lưu để tiếp tục tạo KH Mục tiêu mới này hoặc nhấp Hủy để quay lại module mà không cần tạo KH Mục tiêu.',
    ...
    'LNK_PROSPECT_LIST' => 'Xem KH Mục tiêu',
    ...
    'LBL_SELECT_CHECKED_BUTTON_LABEL' => 'Chọn lựa KH Mục tiêu',
    'LBL_SELECT_CHECKED_BUTTON_TITLE' => 'Chọn lựa KH Mục tiêu',
    'LBL_INVALID_EMAIL' => 'Email không tồn tại:',
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'KH Mục tiêu',
    'LBL_PROSPECT_LIST' => 'Danh sách Tiềm năng',
    'LBL_CONVERT_BUTTON_TITLE' => 'Chuyển đối KH Mục tiêu',
    'LBL_CONVERT_BUTTON_LABEL' => 'Chuyển đối KH Mục tiêu',
