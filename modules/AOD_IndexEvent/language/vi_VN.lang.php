...
$mod_strings = array(
    ...
    'LBL_EDIT_BUTTON' => 'Sửa',
    'LBL_REMOVE' => 'Xóa bỏ',
    'LBL_LIST_FORM_TITLE' => 'Danh sách chỉ số sự kiện',
    'LBL_MODULE_NAME' => 'Chỉ số sự kiện',
    'LBL_MODULE_TITLE' => 'Chỉ số sự kiện',
    'LBL_HOMEPAGE_TITLE' => 'Chỉ số sự kiện của tôi',
    'LNK_NEW_RECORD' => 'Tạo chỉ số sự kiện',
    'LNK_LIST' => 'Xem chỉ số sự kiện',
    'LBL_SEARCH_FORM_TITLE' => 'Tìm kiếm chỉ số sự kiện',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Xem lịch sử',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Hoạt động',
    'LBL_NEW_FORM_TITLE' => 'Chỉ số sự kiện mới',
    'LBL_ERROR' => 'Lỗi',
